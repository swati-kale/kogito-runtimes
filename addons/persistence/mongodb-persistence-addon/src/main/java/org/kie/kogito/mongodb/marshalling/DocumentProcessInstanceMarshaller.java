...
public class DocumentProcessInstanceMarshaller extends AbstractProtobufProcessInstanceMarshaller {
    ...
    public <T extends Model> ProcessInstance<T> unmarshallProcessInstance(ProcessInstanceDocument doc, Process<?> process) {
    ...
    public <T extends Model> ProcessInstance<T> readProcessInstance(ProcessInstanceDocument doc, Process<?> process, AbstractProcessInstance<?> processInstance) {
        try {
