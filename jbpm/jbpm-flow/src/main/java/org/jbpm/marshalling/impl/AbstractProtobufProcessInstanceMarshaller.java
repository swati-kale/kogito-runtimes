...
public abstract class AbstractProtobufProcessInstanceMarshaller
    ...
    public JBPMMessages.ProcessInstance writeProcessInstance(MarshallerWriteContext context,
        ...
        for (Map.Entry<String, Object> variable : variables) {
            if (variable.getValue() != null) {
                _instance.addVariable(ProtobufProcessMarshaller.marshalVariable(context, variable.getKey(), variable.getValue()));
            }
        }
        ...
        if (nodeInstance instanceof RuleSetNodeInstance) {
            ...
            if (variableScopeInstance != null) {
                ...
                for (Map.Entry<String, Object> variable : variables) {
                    ...
                    _foreach.addVariable(ProtobufProcessMarshaller.marshalVariable(context, variable.getKey(), variable.getValue()));
                }
            }
            ...
            if (variableScopeInstance != null) {
                ...
                for (Map.Entry<String, Object> variable : variables) {
                    ...
                    _composite.addVariable(ProtobufProcessMarshaller.marshalVariable(context, variable.getKey(), variable.getValue()));
                }
            }
    ...
    public static JBPMMessages.WorkItem writeWorkItem(MarshallerWriteContext context,
        ...
        for (Map.Entry<String, Object> entry : parameters.entrySet()) {
            _workItem.addVariable(ProtobufProcessMarshaller.marshalVariable(context, entry.getKey(), entry.getValue()));
        }
    ...
    public ProcessInstance readProcessInstance(MarshallerReaderContext context) throws IOException {
        ...
        if (_instance.getVariableCount() > 0) {
            ...
            for (JBPMMessages.Variable _variable : _instance.getVariableList()) {
                Object _value = ProtobufProcessMarshaller.unmarshalVariableValue(context, _variable);
