...
public interface ObjectMarshallingStrategy {
    ...
    byte[] marshal(Context context,
                   ...
                   Object object) throws MarshallingException;
    ...
    Object unmarshal(String dataType,
                     ...
                     byte[] object,
                     ClassLoader classloader) throws UnmarshallingException;
    ...
    String marshalToJson(Object value) throws MarshallingException;

    Object unmarshalFromJson(String dataType, String json) throws UnmarshallingException;
}
